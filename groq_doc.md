[![Groq](https://console.groq.com/groq-logo.svg)](https://console.groq.com/home)**Personal**
...
![432_ MDAqueeL](https://lh3.googleusercontent.com/a/ACg8ocL9QfHM4JPifzHjOt_wW2FC8EuYUgvJR7x5sDGPVxAZkZA=s96-c)
...
## [API Endpoints](https://console.groq.com/docs/speech-to-text#api-endpoints)
...
## [Supported Models](https://console.groq.com/docs/speech-to-text#supported-models)
...
## [Which Whisper Model Should You Use?](https://console.groq.com/docs/speech-to-text#which-whisper-model-should-you-use)
...
## [Working with Audio Files](https://console.groq.com/docs/speech-to-text#working-with-audio-files)
...
### [Audio Preprocessing](https://console.groq.com/docs/speech-to-text#audio-preprocessing)
...
### [Working with Larger Audio Files](https://console.groq.com/docs/speech-to-text#working-with-larger-audio-files)
...
## [Using the API](https://console.groq.com/docs/speech-to-text#using-the-api)
...
| `language`                  | `string` | Optional                               | The language of the input audio. Supplying the input language in ISO-639-1 (i.e.`en,<span> </span>`tr`) format will improve accuracy and latency.``The translations endpoint only supports 'en' as a parameter option.                                                                                                                                                                                           |
...
### [Example Usage of Transcription Endpoint](https://console.groq.com/docs/speech-to-text#example-usage-of-transcription-endpoint)
...
### [Example Usage of Translation Endpoint](https://console.groq.com/docs/speech-to-text#example-usage-of-translation-endpoint)
...
## [Understanding Metadata Fields](https://console.groq.com/docs/speech-to-text#understanding-metadata-fields)
...
### [Using Metadata for Debugging](https://console.groq.com/docs/speech-to-text#using-metadata-for-debugging)
...
### [Quality Thresholds and Regular Monitoring](https://console.groq.com/docs/speech-to-text#quality-thresholds-and-regular-monitoring)
...
### [Prompting Guidelines](https://console.groq.com/docs/speech-to-text#prompting-guidelines)
